    ...
    <>
      <section className="card-cta">
        <div className="flex flex-col gap-6 max-w-lg">
          <h2>Get Job Ready with AI Agent</h2>
          <p className="text-lg">
           ZERO to HERO with instant AI feedback on your mock interviews. Practice, learn, and conquer your next job interview with confidence!
          </p>
